...
namespace Lean.Touch
{
	...
	public class LeanScreenDepth_Drawer : PropertyDrawer
	{
		...
		public override void OnGUI(Rect rect, SerializedProperty property, GUIContent label)
		{
			...
			EditorGUI.indentLevel++;
			{
				...
				case LeanScreenDepth.ConversionType.FixedDistance:
					{
						var color = GUI.color;
						if (property.FindPropertyRelative("Distance").floatValue == 0.0f) GUI.color = Color.red;
				...
				case LeanScreenDepth.ConversionType.PhysicsRaycast:
					{
						var color = GUI.color;
						if (property.FindPropertyRelative("Layers").intValue == 0) GUI.color = Color.red;
		...
		where T : Object
		{
			...
			var color = GUI.color;
			if (oldValue == null) GUI.color = Color.red;
